...
module Result: {
  ...
  */
  ...
  /**
    [Result.ok(value)] returns [Ok(value)]. Use this to construct a successful
  ...
  */
  ...
  /**
    [Result.error(value)] returns [Error(value)]. Use this to construct a failing
    result without having to depend directly on Belt or Base.
  ...
  */
  ...
  /** Run the provided function and wrap the returned value in {!Result}, catching any exceptions raised. */
  let attempt: (unit => 'ok) => t(exn, 'ok);

  let fromOption: (option('ok), ~error: 'error) => t('error, 'ok);
  ...
  */
  ...
  /**
    [Result.map2 ~f: resultA result_b] applies
    [], a function taking two non-[Result] parameters and returning a
...
module Option: {
  /**
    ...
    But how to get the value **out** of the option
    - orElse
    - get
    - getOrFailWith

    When should you result instead?
  ...
  /**
    [Option.or_ optA opt_b] returns
    [optA] if it is of the form [Some x];
  ...
  */
  ...
  /**
    [Option.toList opt] returns the list [[x]] if [opt] is of the form [Some x];
    otherwise, it returns the empty list.
  */

  let isSome: t('a) => bool;
  /**
    [Option.isSome opt] returns [true] if [opt] is a [Some] value, [false] otherwise.
  */
...
module Char: {
  ...
  */
  ...
  /**
    [Char.fromString s] converts the first (and only) character in [s] to [Some ch].
    If the length of [s] is not equal to one, returns [None].

    {[
    Char.fromString "R"= Some 'R'
    Char.fromString "wrong" = None
  ...
  */
  ...
  /**
    For characters in the range ['A'] to ['Z'], [Char.toLowercase ch] returns the
    corresponding lower case letter; for any characters outside that
    range, returns the character unchanged.

    {[
      Char.toLowercase 'G' = 'g'
      Char.toLowercase 'h' = 'h'
      Char.toLowercase '%' = '%'
    ]}
  */
...
module Int: {
  /**
    ...
    TODO you can use the {!Integer} module.
...
module Integer: {
  ...
  */
  ...
  let fromInt64: Int64.t => t;

  let fromFloat: float => t;

  /** Attempt to parse a [string] into a [Integer].
    {[
      Integer.fromString "0" = Some 0.
      Integer.fromString "42" = Some 42.
      Integer.fromString "-3" = Some (-3)
      Integer.fromString "123_456" = Some 123_456
      Integer.fromString "0xFF" = Some 255
      Integer.fromString "0x00A" = Some 10
      Integer.fromString "Infinity" = None
      Integer.fromString "NaN" = None
    ]}
  */
  let fromString: string => option(t);
  ...
  /** Add two {!Integer}s.
    ...
    {[
      open Integer;
      fromInt(3002) + fromInt(4004) = 7006
    ]}
  ...
  */
  ...
  /** Exponentiation, takes the base first, then the exponent.
    ...
    {[7 ** 3 = 343]}
  */
  let power: (~modulo: t=?, ~base: t, ~exponent: t) => t;
...
module Tuple3: {
  ...
  */
  ...
  /** Transform all the values of a tuple using the same function.
    ...
    {[Tuple2.mapAll ~f:Float.squareRoot (9., 16., 25.) = (3., 4., 5.)]}
  ...
  */
  ...
  /** [uncurry f] takes a function [f] which takes three arguments and returns a function which takes a single argument of a {!Tuple3}
    ...
    {[
      let sum (a : int) (b : int) (c : int) : int = a + b + c in

      let uncurriedSum : (int * int * int) -> int = uncurry sum in
...
module String: {
  ...
  */
  ...
  /**
    [String.fromList chars] makes a new string from the given list of
  ...
  */
  ...
  /**
    [String.dropLeft ~count:n str] drops [n] characters from the beginning of
  ...
  */
  ...
  /**
    [String.dropRight(~count=n, str)] drops [n] characters from the end of
    the string [str].
  ...
  */
  ...
  /**
    TODO decide if this should return an array or a list.
  ...
  */
  ...
  /**
    [String.endsWith ~suffix: sfx s] returns [true] if
    [s] ends with [sfx], [false] otherwise.
    [String.endsWith ~suffix:"" s] always returns [true].
  */

  let endsWith: (t, ~suffix: string) => bool;

  /**
    [String.startsWith ~prefix:pfx str] returns [true] if
  ...
  */
  ...
  /**
    [String.toLower s] converts all upper case letters in [s] to
  ...
  */
  ...
  /**
    // TODO remove this
    [String.fromInt n] converts the given integer to a
    base 10 string representation. Gets rid of leading
    zeros and does base conversion.

    {[
    String.fromInt (-3) = "-3"
    String.fromInt 009 = "9"
    String.fromInt 0xa5 = "165"
    ]}
  */
  ...
  */
  ...
  module String: {
    ...
    */
    ...
    let fromArray: array(String.t) => t;

    /** Create a set from a {!List}
      {[Set.String.fromList [|"a";"b";"g";"b";"g";"a";"a"|] |> Set.toList = ["a";"b";"g"]]}
    */

    let fromList: list(String.t) => t;
  };
};
...
module List: {
  ...
  */
  let dropWhile: (~f: 'a => bool, t('a)) => t('a);
  ...
  */
  ...
  /**
    [List.groupWhile ~f: xs] produces a list of lists. Each sublist consists of
    consecutive elements of [xs] which belong to the same group according to [].

    [] takes two parameters and returns a [bool]: [true] if
  ...
  */
  ...
  /**
    [List.forEach ~f:  xs] applies the given function
